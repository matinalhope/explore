package com.matianl.explore.java7concurrency.Chapter7.ch7_recipe02.src.com.packtpub.java7.concurrency.chapter7.recipe02.core;

import java.util.concurrent.PriorityBlockingQueue;
import java.util.concurrent.ThreadPoolExecutor;
import java.util.concurrent.TimeUnit;

import com.matianl.explore.java7concurrency.Chapter7.ch7_recipe02.src.com.packtpub.java7.concurrency.chapter7.recipe02.task.MyPriorityTask;
